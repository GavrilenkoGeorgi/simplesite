    ...
    content: {
      mainPageText: {
        groupTraining: {
          ...
          text: `На групповых занятиях дважды в неделю вы получаете <strong>практический
            и теоретический инструктаж</strong> как проводить воспитание и дрессировку поэтапно далее в домашних
            условиях.
            ...
            — хорошим выполнением всех <strong>необходимых базовых команд</strong>. Вы получите послушную,
        ...
        individualTraining: {
          ...
          text: `При индивидуальных занятиях мы тренируем собаку тет-а-тет с вами или
            самостоятельно там, где, когда и во сколько вам удобно. Тренировка ориентирована на <strong>потребности
            сугубо вашей собаки</strong> и соответственно обучение дает максимальный результат в сжатые сроки.
            Мы мобильны и выезжаем к нашим клиентам в такие населённые пункты: <strong>Свято-Петровское, Чайки,
            Бобрица, Белогородка, Стоянка, Ирпень, Дмитровка, Софиевская Борщаговка, Киев и другие
            города Киевской области.</strong>`
        },
